...
def parse_args():
    ...
    parser.add_argument('--docs', nargs='?', default='src/Problem_2/data/MED.ALL',
                        help='Path of the document file.')
    parser.add_argument('--queries', nargs='?', default='src/Problem_2/data/MED.QRY',
                        help='Path of the query file.')
    parser.add_argument('--gt', nargs='?', default='src/Problem_2/data/MED.REL',
